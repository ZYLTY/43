...
// Добавьте следующий код в ваш JavaScript-файл или внутри тега <script> в HTML
function openModal() {
...
function register() {
    ...
    // Здесь вы можете отправить данные на сервер или выполнить необходимые действия
